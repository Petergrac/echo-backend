...
export class Migrations1764333476440 implements MigrationInterface {
    name = 'Migrations1764333476440'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "notification_preferences" DROP CONSTRAINT "REL_b70c44e8b00757584a39322559"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "notification_preferences" ADD CONSTRAINT "REL_b70c44e8b00757584a39322559" UNIQUE ("userId")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_34cb743d36153e131fa42581b9" ON "notification" ("createdAt", "recipientId", "read") `);
