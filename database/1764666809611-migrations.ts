...
export class Migrations1764666809611 implements MigrationInterface {
    name = 'Migrations1764666809611'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "adminMetadata"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "deletedAt"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "emailVerified"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "isModerator"`);
        ...
        await queryRunner.query(`ALTER TABLE "media" ADD "post_id" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "is_moderator" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "admin_metadata" jsonb NOT NULL DEFAULT '{}'`);
        ...
        await queryRunner.query(`ALTER TABLE "follows" ADD "following_id" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "follows" ADD "follower_id" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "follows" ALTER COLUMN "followerId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "follows" ALTER COLUMN "followingId" DROP NOT NULL`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_aab7dfdf4bbfc8c2aa586fed64" ON "post" ("authorId", "visibility", "created_at") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_aab7dfdf4bbfc8c2aa586fed64"`);
        ...
        await queryRunner.query(`ALTER TABLE "follows" ALTER COLUMN "followingId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "follows" ALTER COLUMN "followerId" SET NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "admin_metadata"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "is_moderator"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "banReason" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "isModerator" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "adminMetadata" jsonb NOT NULL DEFAULT '{}'`);
